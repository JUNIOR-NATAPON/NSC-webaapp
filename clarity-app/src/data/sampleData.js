// NOTE: no longer imported anywhere in the app — every page now reads live
// data from Firebase (see src/context/DeviceContext.jsx and src/lib/).
// Kept here only as a reference for the data shapes each page originally
// expected, in case you want to add a demo/offline mode later.
